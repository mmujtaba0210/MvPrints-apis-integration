      ...
      <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    } focus:ring-2 focus:ring-sky-500 focus:border-sky-500 appearance-none`}
                  >
            ...
            <div className="mt-8">
              <button
                ...
                } focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 flex items-center justify-center space-x-2`}
              >
                {isSubmitting ? (
                  <>
                    <svg
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 text-green-700 rounded-lg flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600">
                    Your SMS has been delivered to the recipient.
                  </p>
                </div>
              </div>
            )}
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 inline mr-1 text-sky-500"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
