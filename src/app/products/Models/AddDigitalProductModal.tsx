...
import { AddDigitalProductForm } from "../components/DigitalProductComponents/main-digital-product-form";

interface AddDigitalProductModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}
