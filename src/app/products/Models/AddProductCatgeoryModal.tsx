...
const AddProductCategoryModal: React.FC<AddProductCategoryModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col border border-gray-100">
        ...
        <div className="overflow-y-auto flex-1">
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            {/* Modal Footer */}
            <div className="flex justify-end space-x-4 pt-4 border-t border-gray-100 sticky bottom-0 bg-white pb-2">
              <button
                type="button"
                onClick={onClose}
