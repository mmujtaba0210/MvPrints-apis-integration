...
import { PricingForm } from "../../forms/components/PricingForm";
...
import { ShippingForm } from "../../forms/components/ShippingForm";
import { ProductIdentifiersForm } from "../../forms/components/ProductIdentifiersForm";
...
export const AddQuotationProductForm = () => {
  ...
  const categories = [
    ...
    { id: "4", name: "Custom Fabrication" },
  ];

  const subCategories = [
    { id: "1", name: "Machinery", parentId: "1" },
    { id: "2", name: "Tools", parentId: "1" },
    { id: "3", name: "Building Materials", parentId: "2" },
    { id: "4", name: "Safety Equipment", parentId: "2" },
  ];

  const childCategories = [
    { id: "1", name: "Heavy Machinery", parentId: "1" },
    { id: "2", name: "Power Tools", parentId: "2" },
    { id: "3", name: "Electrical", parentId: "3" },
    { id: "4", name: "Plumbing", parentId: "3" },
  ];

  const onSubmit = (data: any) => {
    console.log("Quotation product submitted:", data);
